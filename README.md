## this repository is an example for use [localise](https://localise.biz/) to generate website content
...
5. run yarn start, it will auto download contents from localise
